...
EXPERIMENTS = (
    ExperimentDesign(
        ...
        "Interaction sensitivity: whether gains appear only when interaction is activated.",
    ...
    ExperimentDesign(
        ...
        "Safety/performance tradeoff: recall@K, downstream work, and interaction-aware decision metrics.",
    ...
    ExperimentDesign(
        ...
        "Retrieval safety: recall@K versus candidate work.",
